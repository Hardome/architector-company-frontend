...
const mediaItems = [
  {src: '/topPerspective.webp', alt: 'Вид сверху на поселок'},
  {src: '/topPerspective2.webp', alt: 'Жизнь в поселке'},
  {src: '/architecture.webp', alt: 'Архитектура домов'},
  {src: '/road3.webp', alt: 'Сервисы поселка'}
];
